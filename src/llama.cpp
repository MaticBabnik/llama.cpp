...
static std::pair<int, llama_model *> llama_model_load(struct gguf_context * metadata, llama_model_set_tensor_data_t set_tensor_data, void * set_tensor_data_ud,
        const std::string & fname, std::vector<std::string> & splits, FILE * file, const void * buf_data, size_t buf_size, llama_model_params & params) {
    try {
        llama_model_loader ml(metadata, set_tensor_data, set_tensor_data_ud, fname, splits, file, buf_data, buf_size, params.load_mode,
...
static struct llama_model * llama_model_load_from_file_impl(
    ...
    const auto [status, model] = llama_model_load(metadata, set_tensor_data, set_tensor_data_ud, path_model, splits, file, buf_data, buf_size, params);
...
struct llama_model * llama_model_init_from_user(
    ...
    return llama_model_load_from_file_impl(metadata, set_tensor_data, set_tensor_data_ud, path_model, splits, /*file*/ nullptr, /*buf_data*/ nullptr, 0, params);
}
// deprecated
...
struct llama_model * llama_model_load_from_file(
        ...
        struct llama_model_params params) {
    std::vector<std::string> splits = {};
    return llama_model_load_from_file_impl(nullptr, nullptr, nullptr, path_model, splits, /*file*/ nullptr, /*buf_data*/ nullptr, 0, params);
}
...
struct llama_model * llama_model_load_from_splits(
    ...
    return llama_model_load_from_file_impl(nullptr, nullptr, nullptr, splits.front(), splits, /*file*/ nullptr, /*buf_data*/ nullptr, 0, params);
}
...
struct llama_model * llama_model_load_from_file_ptr(FILE * file, struct llama_model_params params) {
    ...
    std::string path_model;
    std::vector<std::string> splits = {};
    return llama_model_load_from_file_impl(nullptr, nullptr, nullptr, path_model, splits, file, /*buf_data*/ nullptr, 0, params);
}

struct llama_model * llama_model_load_from_buffer(const void * data, size_t size, struct llama_model_params params) {
    if (!data || size == 0) {
    ...
    std::string path_model;
    std::vector<std::string> splits = {};
    return llama_model_load_from_file_impl(nullptr, nullptr, nullptr, path_model, splits, /*file*/ nullptr, data, size, params);
}
